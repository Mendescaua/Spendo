    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          final isSelected = tipo == _selectedTipo;

          return GestureDetector(
            onTap: () {
              setState(() {
                _selectedTipo = tipo; // Atualiza seleção local
              });
              widget.onIconSelected(iconData, tipo);
            },
